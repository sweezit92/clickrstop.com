		...
		<header>
			...
			<a href="index.html">
				<figure class="logo-mobile">
					<img src="<?php echo base_url();?>images/logo_mobile.png" alt="logo-mobile">
				</figure>
			</a>
			<!-- /LOGO MOBILE -->
						...
						<ul class="dropdown cart closed">
							...
							<li class="dropdown-item">
								...
								<figure class="product-preview-image tiny">
									<img src="<?php echo base_url();?>images/pixel_s.jpg" alt="">
								</figure>
							...
							<li class="dropdown-item">
								...
								<!-- /SVG PLUS -->
								<figure class="product-preview-image tiny">
									<img src="<?php echo base_url();?>images/monsters_s.jpg" alt="">
								</figure>
							...
							<li class="dropdown-item">
								...
								<!-- /SVG PLUS -->
								<figure class="product-preview-image tiny">
									<img src="<?php echo base_url();?>images/flat_s.jpg" alt="">
								</figure>
					...
					<div class="account-email-quickview">
						...
						<ul class="dropdown notifications closed">
							...
							<li class="dropdown-item">
								<a href="dashboard-openmessage.html" class="link-to"></a>
								<figure class="user-avatar">
									<img src="<?php echo base_url();?>images/avatar_04.jpg" alt="">
								</figure>
							...
							<li class="dropdown-item">
								<a href="dashboard-openmessage.html" class="link-to"></a>
								<figure class="user-avatar">
									<img src="<?php echo base_url();?>images/avatar_07.jpg" alt="">
								</figure>
							...
							<li class="dropdown-item">
								<a href="dashboard-openmessage.html" class="link-to"></a>
								<figure class="user-avatar">
									<img src="<?php echo base_url();?>images/avatar_08.jpg" alt="">
								</figure>
					...
					<div class="account-settings-quickview">
						...
						<ul class="dropdown notifications no-hover closed">
							...
							<li class="dropdown-item">
								<a href="author-profile.html">
									<figure class="user-avatar">
										<img src="<?php echo base_url();?>images/avatar_05.jpg" alt="">
									</figure>
								</a>
								<p class="title">
