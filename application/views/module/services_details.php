...
?>
	...
	<div class="section-headline-wrap v3">
		<div class="section-headline">
			<h2>Professional Corporate Logos</h2>
			<p>Home<span class="separator">/</span>Services<span class="separator">/</span><span class="current-section">Graphic Design</span></p>
		</div>
	</div>
	<!-- /SECTION HEADLINE -->
		...
		<div class="section">
				...
				<article class="post">
					...
					<div class="post-image">
						<figure class="product-preview-image large liquid">
							<img src="<?php echo base_url();?>images/logos_b01.jpg" alt="">
						</figure>
					</div>
					<!-- /POST IMAGE -->
						...
						<div class="image-slides-wrap">
							...
							<div class="image-slides" data-slide-visible-full="6" 
								...
								<div class="image-slide">
									<div class="overlay"></div>
									<figure class="product-preview-image thumbnail liquid">
										<img src="<?php echo base_url();?>images/logos_b02.jpg" alt="">
									</figure>
								</div>
								<!-- /IMAGE SLIDE -->
								...
								<div class="image-slide">
									<div class="overlay"></div>
									<figure class="product-preview-image thumbnail liquid">
										<img src="<?php echo base_url();?>images/logos_b03.jpg" alt="">
									</figure>
								</div>
								<!-- /IMAGE SLIDE -->
								...
								<div class="image-slide">
									<div class="overlay"></div>
									<figure class="product-preview-image thumbnail liquid">
										<img src="<?php echo base_url();?>images/logos_b04.jpg" alt="">
									</figure>
								</div>
								<!-- /IMAGE SLIDE -->
								...
								<div class="image-slide">
									<div class="overlay"></div>
									<figure class="product-preview-image thumbnail liquid">
										<img src="<?php echo base_url();?>images/logos_b05.jpg" alt="">
									</figure>
								</div>
								<!-- /IMAGE SLIDE -->
					...
					<div class="post-content">
						...
						<div class="post-paragraph">
							<h3 class="post-title">Compare Packages</h3>
				...
				<div class="post-tab">
					...
					<div class="tab-header secondary">
						...
						<div class="tab-item selected">
							<p class="text-header">Feedback (35)</p>
						</div>
						<!-- /TAB ITEM -->
					...
					<div class="tab-content void">
						...
						<div class="comment-list">
							...
							<div class="comment-wrap">
								...
								<a href="user-profile.html">
									<figure class="user-avatar medium">
										<img src="<?php echo base_url();?>images/avatar_11.jpg" alt="">
									</figure>
								</a>
								<!-- /USER AVATAR -->
								<div class="comment">
							...
							<div class="comment-wrap">
								...
								<a href="user-profile.html">
									<figure class="user-avatar medium">
										<img src="<?php echo base_url();?>images/avatar_03.jpg" alt="">
									</figure>
								</a>
								<!-- /USER AVATAR -->
								<div class="comment">
			...
			<div class="sidebar right">
				<!-- SIDEBAR ITEM -->
					...
					<a href="#" class="button mid dark-light">Feel Free <span class="secondary">To Ask?</span></a>
				...
				<div class="sidebar-item author-bio v2">
					...
					<a href="user-profile.html" class="user-avatar-wrap medium">
						<figure class="user-avatar medium">
							<img src="<?php echo base_url();?>images/avatar_14.jpg" alt="">
						</figure>
					</a>
					<!-- /USER AVATAR -->
