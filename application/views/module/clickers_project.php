				...
				<div class="sidebar-item author-bio">
					...
					<a href="user-profile.html" class="user-avatar-wrap medium">
						<figure class="user-avatar medium">
							<img src="<?php echo base_url();?><?php echo base_url();?>images/avatar_09.jpg" alt="">
						</figure>
					</a>
					<!-- /USER AVATAR -->
					...
					<div class="product-list list">
						...
						<div class="product-item">
							<a href="item-v1.html">
								...
								<figure class="product-preview-image small">
									<img src="<?php echo base_url();?>images/westeros_s.jpg" alt="product-image">
								</figure>
								<!-- /PRODUCT PREVIEW IMAGE -->
							</a>
						...
						<div class="product-item">
							<a href="item-v1.html">
								<!-- PRODUCT PREVIEW IMAGE -->
								<figure class="product-preview-image small">
									<img src="<?php echo base_url();?>images/alchemists_s.jpg" alt="product-image">
								</figure>
								<!-- /PRODUCT PREVIEW IMAGE -->
							</a>
