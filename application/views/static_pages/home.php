...
<?php
	...
	<div class="banner-wrap" style="height:680px;">
		<section class="banner">
			...
			<h3 style="color:#fff;">
				<div class="website_homepage_1st_screen_no_more_value" style="position:absolute;text-align:center;width:100%;">
					&nbsp;<div class="website_homepage_1st_screen_no_more_value_text">O</div>
				</div>
			</h3>
			
			<!-- SEARCH WIDGET -->
			<div class="search-widget" style="margin-top:50px;">
	...
	<!-- /BANNER -->
		...
		<div class="section " style="margin-top:-50px;">
			<div class="product-showcase">
				<div class="head-title">
					...
					<p>You have an opportunity to choose from 1000+ photographers. From amature to professional we have all range of photographers based on your budget from your locality.</p>
				</div>
		...
		<!-- how it works -->
			<div class="section overflowable" style="margin-top:-100px;height:500px;">
				<div class="headline primary" style="background:#f5f5f5;">
					<h4>How it works</h4>
				</div>
